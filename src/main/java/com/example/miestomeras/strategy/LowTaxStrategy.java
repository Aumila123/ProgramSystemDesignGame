...
public class LowTaxStrategy implements TaxStrategy {
    ...
    private static final int TAX_PER_PERSON = 25;
    private static final int HAPPINESS_PENALTY = 3;
    ...
    public String getDescription() {
        return "Low Tax (€" + TAX_PER_PERSON + " per person, -" + HAPPINESS_PENALTY + "% happiness)";
    }
